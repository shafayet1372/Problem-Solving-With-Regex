...
A magic sigil is a glyph which represents a desire one wishes to manifest in their lives. There are many ways to create a sigil, but the 
most common is to write out a specific desire (e.g. "I HAVE WONDERFUL FRIENDS WHO LOVE ME"), remove all vowels, remove any duplicate letters 
...
let str= desire.replace(/[aeiou\s]/gi,'').toUpperCase()

return str.split("").filter((x,i)=>i==str.lastIndexOf(x)).join("")
}
